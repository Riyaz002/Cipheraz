...
class IntegrityCheckActivity : AppCompatActivity() {
    ...
    private fun resetImage() {
        binding.integrityResultPic.setImageResource(R.color.cardview_light_background)
    }
    ...
    private fun checkIntegrity() {
        contentResolver.apply {
            ...
            if (isFilesSame(hashValue1, hashValue2)) {
    ...
    private fun isFilesSame(
        hashValue1: ByteArray,
        hashValue2: ByteArray
    ) = hashValue1.contentEquals(hashValue2)
